...
const ResumeBuilderNew: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen ${isDark ? 'bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950' : 'bg-gradient-to-br from-indigo-50 via-white to-purple-50'}`}>
      {/* Floating Action Bar */}
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="mb-12 text-center">
          ...
          <p className={`text-lg ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>Create your professional resume in minutes</p>
        </div>

        {/* Template & Color Selector */}
        <div className={`mb-8 ${isDark ? 'bg-slate-900/80 border-slate-700' : 'bg-white border-gray-100'} backdrop-blur-xl rounded-3xl p-6 shadow-lg border`}>
          <div className="flex flex-wrap items-center gap-6">
            <div className="flex items-center gap-3">
              <span className="material-symbols-outlined text-indigo-600">palette</span>
              <span className={`font-bold text-sm ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>Theme Color:</span>
              <input
                type="color"
                value={themeColor}
            ...
            <div className="flex items-center gap-3">
              ...
              <span className={`font-bold text-sm ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>Template:</span>
              <select
                value={selectedTemplate}
                onChange={(e) => setSelectedTemplate(e.target.value)}
                className={`px-4 py-2 rounded-xl border-2 font-medium focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 ${isDark ? 'border-slate-600 bg-slate-800 text-white' : 'border-gray-200 bg-white text-gray-900'}`}
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            {/* Personal Info Card */}
            <div className={`${isDark ? 'bg-slate-900/80 border-slate-700' : 'bg-white border-gray-100'} backdrop-blur-xl rounded-3xl p-8 shadow-lg border`}>
              <div className="flex items-center gap-3 mb-6">
                <div className="p-3 bg-indigo-100 dark:bg-indigo-900/30 rounded-2xl">
                  <span className="material-symbols-outlined text-indigo-600 dark:text-indigo-400">person</span>
                </div>
                <h2 className={`text-2xl font-black ${isDark ? 'text-white' : 'text-gray-900'}`}>Personal Info</h2>
              </div>
              <div className="space-y-4">
                <input
                  ...
                  className={`w-full px-4 py-3 rounded-xl border-2 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all ${isDark ? 'border-slate-600 bg-slate-800 text-white placeholder-gray-400' : 'border-gray-200 bg-white text-gray-900'}`}
                />
                <div className="grid grid-cols-2 gap-4">
                  <input
                    ...
                    className={`px-4 py-3 rounded-xl border-2 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all ${isDark ? 'border-slate-600 bg-slate-800 text-white placeholder-gray-400' : 'border-gray-200 bg-white text-gray-900'}`}
                  />
                  <input
                    type="tel"
                    placeholder="Phone"
                ...
                <textarea
                  ...
                  className={`w-full px-4 py-3 rounded-xl border-2 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all resize-none h-24 ${isDark ? 'border-slate-600 bg-slate-800 text-white placeholder-gray-400' : 'border-gray-200 bg-white text-gray-900'}`}
                />
              </div>
            </div>
            ...
            <div className={`${isDark ? 'bg-slate-900/80 border-slate-700' : 'bg-white border-gray-100'} backdrop-blur-xl rounded-3xl p-8 shadow-lg border`}>
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className={`text-2xl font-black ${isDark ? 'text-white' : 'text-gray-900'}`}>Experience</h2>
                </div>
                <button
                  onClick={addExperience}
                  className="p-2 bg-purple-100 dark:bg-purple-900/30 hover:bg-purple-600 text-purple-600 dark:text-purple-400 hover:text-white rounded-xl transition-all"
                >
              ...
              <div className="space-y-4">
                {resumeData.experiences.map((exp) => (
                  <div key={exp.id} className={`p-4 rounded-2xl space-y-3 relative group ${isDark ? 'bg-slate-800/50' : 'bg-gray-50'}`}>
                    <button
            ...
            <div className={`${isDark ? 'bg-slate-900/80 border-slate-700' : 'bg-white border-gray-100'} backdrop-blur-xl rounded-3xl p-8 shadow-lg border`}>
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className={`text-2xl font-black ${isDark ? 'text-white' : 'text-gray-900'}`}>Education</h2>
                </div>
                <button
                  onClick={addEducation}
                  className="p-2 bg-green-100 dark:bg-green-900/30 hover:bg-green-600 text-green-600 dark:text-green-400 hover:text-white rounded-xl transition-all"
                >
                  <span className="material-symbols-outlined">add</span>
                </button>
              </div>
            ...
            <div className={`${isDark ? 'bg-slate-900/80 border-slate-700' : 'bg-white border-gray-100'} backdrop-blur-xl rounded-3xl p-8 shadow-lg border`}>
              <div className="flex items-center gap-3 mb-6">
                <div className="p-3 bg-orange-100 dark:bg-orange-900/30 rounded-2xl">
                  <span className="material-symbols-outlined text-orange-600 dark:text-orange-400">star</span>
                </div>
                <h2 className={`text-2xl font-black ${isDark ? 'text-white' : 'text-gray-900'}`}>Skills</h2>
              </div>
              <div className="space-y-4">
                <div className="flex gap-2">
                  <input
                    ...
                    className={`flex-1 px-4 py-3 rounded-xl border-2 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all ${isDark ? 'border-slate-600 bg-slate-800 text-white placeholder-gray-400' : 'border-gray-200 bg-white text-gray-900'}`}
                  />
                </div>
          ...
          <div className="lg:sticky lg:top-24 h-fit">
            <div className={`${isDark ? 'bg-slate-900/80 border-slate-700' : 'bg-white border-gray-100'} backdrop-blur-xl rounded-3xl p-8 shadow-2xl border`}>
              <div className="flex items-center gap-3 mb-6">
                <span className="material-symbols-outlined text-indigo-600 dark:text-indigo-400">visibility</span>
                <h3 className={`text-xl font-black ${isDark ? 'text-white' : 'text-gray-900'}`}>Live Preview</h3>
              </div>
              <div
                ref={resumePreviewRef}
                className={`shadow-xl rounded-2xl p-8 border-2 min-h-[600px] ${isDark ? 'bg-white border-gray-200' : 'bg-white border-gray-100'}`}
